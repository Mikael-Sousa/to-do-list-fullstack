  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-transparent backdrop-blur-xl shadow-md z-50">
      <div className="max-w-7xl mx-auto flex justify-between items-center h-20 px-8">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `text-white font-medium px-5 py-1 rounded-2xl border-2
                    ...
                    isActive ? 'bg-white/20 border-white text-black' : 
        ...
        <button
          className="md:hidden flex flex-col justify-center items-center gap-1 p-2 z-50"
          onClick={toggleMenu}
        >
          <span
        ...
        <ul
          className={`fixed top-0 right-0 h-full w-64 bg-black/80 backdrop-blur-xl shadow-lg flex flex-col gap-7 pt-32 px-6 transform transition-transform duration-300 md:hidden ${
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `block text-white text-lg font-medium px-5 py-2 rounded-2xl border-2 border-transparent transition-all duration-700 ${
                    isActive ? 'bg-white/20 border-white text-black' : 'hover:bg-white/20 hover:border-white'
                  }`
                }
                onClick={closeMenu}
              >
